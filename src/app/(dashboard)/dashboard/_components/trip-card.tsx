...
import { MapPin, Calendar, DollarSign, Globe, Lock, Users, ArrowRight } from "lucide-react";
...
const GRADIENT_MAP: Record<string, string> = {
  ...
  PLANNED:   "from-primary/15 via-primary/8 to-transparent",
  ONGOING:   "from-emerald-500/15 via-emerald-500/8 to-transparent",
  COMPLETED: "from-violet-500/15 via-violet-500/8 to-transparent",
};
          ...
          <div className={cn("relative flex h-32 items-center justify-center bg-linear-to-br", gradient)}>
            ...
            <div className="absolute inset-0 flex items-center justify-center bg-primary/0 transition-all duration-200 group-hover:bg-primary/5">
              <motion.div
                ...
                className="flex items-center gap-1.5 rounded-full bg-primary px-3 py-1.5 text-xs font-semibold text-primary-foreground opacity-0 group-hover:opacity-100 transition-opacity"
              >
