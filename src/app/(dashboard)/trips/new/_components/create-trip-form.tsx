...
import {
  ...
  FileText, Sparkles, ArrowRight, Loader2, CheckCircle2,
} from "lucide-react";
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-0">
      ...
      <div className="grid gap-8 lg:grid-cols-[1fr_380px]">
        ...
        <div className="flex flex-col gap-6">
          ...
          >
            ...
            />
            {state.errors?.title && (
              <ErrorMsg messages={state.errors.title} />
            )}
          </motion.div>
          ...
          >
            <div className="flex flex-col gap-2">
              ...
              {state.errors?.startDate && (
                <ErrorMsg messages={state.errors.startDate} />
              )}
            </div>
            <div className="flex flex-col gap-2">
              ...
              {state.errors?.endDate && (
                <ErrorMsg messages={state.errors.endDate} />
              )}
            </div>
          </motion.div>
          ...
          >
            ...
            <p className="mt-2 text-center text-xs text-muted-foreground">
              You can add stops and activities after creating the trip
            </p>
          </motion.div>
        </div>
      ...
      >
        ...
        <ActivitySuggestions destination={title || undefined} />
      </motion.div>
    </form>
  );
}
